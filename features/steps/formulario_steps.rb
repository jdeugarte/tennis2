...
Then(/^veo al jugador(\d+) "(.*?)" y al jugador(\d+) "(.*?)"$/) do |nro_jugador1, nombre1, nro_jugador2, nombre2|
  last_response.body.should =~ /#{'"jugador'+nro_jugador1+'">'+nombre1}/m
  last_response.body.should =~ /#{'"jugador'+nro_jugador2+'">'+nombre2}/m
end

Then(/^el jugador(\d+) tiene el puntaje "(.*?)" al igual que el jugador(\d+) que tiene "(.*?)"$/) do |nro_jugador1, puntaje1, nro_jugador2, puntaje2|
  last_response.body.should =~ /#{'"jugador'+nro_jugador1+'">'+puntaje1}/m
  last_response.body.should =~ /#{'"jugador'+nro_jugador2+'">'+puntaje2}/m
end
